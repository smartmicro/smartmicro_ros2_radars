...
#include <umrr9d_t152_automotive_v0_9_0/DataStreamServiceIface.h>
...
private:
  ...
  void targetlist_callback_umrr9d(
    const std::uint32_t sensor_idx,
    const std::shared_ptr<
      com::master::umrr9d_t152_automotive_v0_9_0::comtargetlistport::ComTargetListPort> &
...
std::shared_ptr<com::master::umrr9d_t152_automotive_v0_9_0::DataStreamServiceIface> data_umrr9d{};
