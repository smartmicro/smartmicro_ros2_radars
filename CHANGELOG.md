...
This patch fixes the max number of sensors that could be connected at once. The patch also modifies the print statements and introduces signal-to-noise field in the pointclouds.